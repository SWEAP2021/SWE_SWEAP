...
class BuyStockPage extends Component {
  ...
  CalTotalCost = () => {
    return this.state.cost * this.state.quantity;
  }; //총 가격=현재가격*현재 개수
  AddCost = () => {
  ...
  changeToSell = () => {
    this.setState({ text: "매도", buttonColor: "button button-blue" });
  }; //매도로 변경
  changeToBuy = () => {
    this.setState({ text: "매수", buttonColor: "button button-red" });
  }; //매수로 변경
  render() {
    return (
      <div className="form">
        ...
        <div className="centered">
          <div className="button-centered">
            ...
            <div onClick={clickToSell} className="button button-blue">
              매도
            </div>
          </div>
          <p>매수 가격 </p>
        ...
        <div className="button-centered">
          <div className="button button-red">매수</div>
          <div className="button button-gray">취소</div>
        </div>
      </div>
    );
  }
